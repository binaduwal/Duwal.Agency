...
const Hero = () => {
 ...
 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800">
        ...
        variants={textVariant(0.4)}
          initial="hidden"
          whileInView="show" className="text-gray-600 text-xl md:text-lg max-w-xl">
      ...
      variants={fadeIn('left',0.5)}
          initial="hidden"
          whileInView="show" className="w-full md:w-1/2 flex mt-6 justify-center items-center z-10">
        <div className="relative">
          ...
          />
<div className="absolute top-0 right-0 w-40 h-40 bg-blue-200 rounded-full blur-2xl opacity-50 z-10"></div>
